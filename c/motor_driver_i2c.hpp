...
constexpr uint8_t MOTOR_MODEL_ADDR = 0x26;  // 0x26 detectado en este Pi; algunas placas usan 0x16

// Motores habilitados (solo M2 y M4 conectados)
constexpr std::array<bool, 4> MOTORS_ENABLED = { false, true, false, true };

// Registros I2C según Docs/IIC communication protocol.pdf (esclavo 0x26)
constexpr uint8_t MOTOR_TYPE_REG = 0x01;
constexpr uint8_t MOTOR_DEADZONE_REG = 0x02;
constexpr uint8_t PLUSE_LINE_REG = 0x03;
constexpr uint8_t PLUSE_PHASE_REG = 0x04;
constexpr uint8_t WHEEL_DIA_REG = 0x05;
constexpr uint8_t SPEED_REG = 0x06;   // 4×int16_t velocidad -1000~1000
constexpr uint8_t PWM_REG = 0x07;     // 4×int16_t PWM -3600~3600
constexpr uint8_t READ_TEN_M1_ENCODER_REG = 0x10;  // 0x10 M1, 0x11 M2, 0x12 M3, 0x13 M4
constexpr uint8_t READ_ALLHIGH_M1_REG = 0x20;     // M1 high, M2=0x22, M3=0x24, M4=0x26
constexpr uint8_t READ_ALLLOW_M1_REG = 0x21;       // M1 low,  M2=0x23, M3=0x25, M4=0x27

constexpr int16_t SPEED_MIN = -1000;
constexpr int16_t SPEED_MAX = 1000;
constexpr int16_t PWM_MIN = -3600;
constexpr int16_t PWM_MAX = 3600;
